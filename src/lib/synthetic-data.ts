...
const ZONE_NAMES: Record<string, string> = {
 ...
 "Zone-U": "Sarjapur Corridor",
 "Zone-V": "Kengeri Satellite Town",
 "Zone-W": "Nagawara Junction",
 "Zone-X": "Bannerghatta Road South",
 "Zone-Y": "Hennur Main Road",
 "Zone-Z": "RR Nagar West",
 "Zone-AA": "Thanisandra Gate",
 "Zone-AB": "Bommanahalli Hub",
 "Zone-AC": "Kadugodi Township",
 "Zone-AD": "Begur Layout",
 "Zone-AE": "KR Puram Bridge",
 "Zone-AF": "Jakkur Aerodrome",
};
...
export function generateZones(): Zone[] {
 ...
 const baselines: Record<string, number> = {
  ...
  "Zone-U": 195, "Zone-V": 160, "Zone-W": 215, "Zone-X": 175,
  "Zone-Y": 205, "Zone-Z": 188, "Zone-AA": 222, "Zone-AB": 268,
  "Zone-AC": 145, "Zone-AD": 178, "Zone-AE": 234, "Zone-AF": 130,
 };
 ...
 const supplies: Record<string, number> = {
  ...
  "Zone-U": 150, "Zone-V": 200, "Zone-W": 240, "Zone-X": 130,
  "Zone-Y": 260, "Zone-Z": 170, "Zone-AA": 290, "Zone-AB": 220,
  "Zone-AC": 110, "Zone-AD": 145, "Zone-AE": 280, "Zone-AF": 380,
 };

 const connections: Record<string, string[]> = {
  "Zone-A":  ["Zone-B", "Zone-I", "Zone-T", "Zone-G"],
  "Zone-B":  ["Zone-A", "Zone-E", "Zone-N", "Zone-S"],
  "Zone-C":  ["Zone-H", "Zone-M", "Zone-AC"],
  "Zone-D":  ["Zone-L", "Zone-O", "Zone-R", "Zone-V"],
  "Zone-E":  ["Zone-B", "Zone-S", "Zone-AB"],
  "Zone-F":  ["Zone-O", "Zone-L", "Zone-X"],
  "Zone-G":  ["Zone-A", "Zone-T", "Zone-K"],
  "Zone-H":  ["Zone-C", "Zone-N", "Zone-AB"],
  "Zone-I":  ["Zone-A", "Zone-T", "Zone-V"],
  "Zone-J":  ["Zone-R", "Zone-K", "Zone-W", "Zone-AF"],
  "Zone-K":  ["Zone-J", "Zone-P", "Zone-G"],
  "Zone-L":  ["Zone-D", "Zone-F", "Zone-O"],
  "Zone-M":  ["Zone-C", "Zone-N", "Zone-U", "Zone-AE"],
  "Zone-N":  ["Zone-B", "Zone-H", "Zone-M", "Zone-AB"],
  "Zone-O":  ["Zone-F", "Zone-D", "Zone-L", "Zone-X"],
  "Zone-P":  ["Zone-K", "Zone-Q"],
  "Zone-Q":  ["Zone-P", "Zone-R"],
  "Zone-R":  ["Zone-Q", "Zone-J", "Zone-D", "Zone-AF"],
  "Zone-S":  ["Zone-E", "Zone-B", "Zone-AB"],
  "Zone-T":  ["Zone-A", "Zone-I", "Zone-G", "Zone-Z"],
  "Zone-U":  ["Zone-M", "Zone-AC", "Zone-AB"],
  "Zone-V":  ["Zone-D", "Zone-I", "Zone-Z"],
  "Zone-W":  ["Zone-J", "Zone-Y", "Zone-AA"],
  "Zone-X":  ["Zone-F", "Zone-O", "Zone-AD"],
  "Zone-Y":  ["Zone-W", "Zone-AA", "Zone-AF"],
  "Zone-Z":  ["Zone-T", "Zone-V", "Zone-AD"],
  "Zone-AA": ["Zone-W", "Zone-Y", "Zone-AF"],
  "Zone-AB": ["Zone-E", "Zone-H", "Zone-N", "Zone-S", "Zone-U"],
  "Zone-AC": ["Zone-C", "Zone-U", "Zone-AE"],
  "Zone-AD": ["Zone-X", "Zone-Z"],
  "Zone-AE": ["Zone-M", "Zone-AC"],
  "Zone-AF": ["Zone-J", "Zone-R", "Zone-Y", "Zone-AA"],
 };
 ...
 const coords: Record<string, [number, number]> = {
  ...
  "Zone-U":  [12.900, 77.710], "Zone-V":  [12.950, 77.490],
  "Zone-W":  [13.060, 77.625], "Zone-X":  [12.898, 77.558],
  "Zone-Y":  [13.055, 77.645], "Zone-Z":  [12.972, 77.510],
  "Zone-AA": [13.065, 77.615], "Zone-AB": [12.888, 77.665],
  "Zone-AC": [12.985, 77.775], "Zone-AD": [12.878, 77.534],
  "Zone-AE": [12.930, 77.740], "Zone-AF": [13.075, 77.600],
 };
