  ...
  return (
    <div className="flex flex-col min-h-[100dvh] bg-[#f9fafb]">
      ...
      <div className="flex-1 w-full max-w-[1600px] mx-auto p-4 md:p-6 grid grid-cols-1 lg:grid-cols-12 gap-6" style={{ minHeight: 'calc(100dvh - 64px)' }}>
        ...
        <section className="lg:col-span-8 flex flex-col relative rounded-xl bg-white shadow-sm border border-slate-200 overflow-hidden">
        ...
        <section className="lg:col-span-4 flex flex-col gap-6 overflow-y-auto pb-6">
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5 flex flex-col">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/redistribution" className="text-sm font-medium text-emerald-600 hover:text-emerald-700 flex items-center gap-1 transition-colors">
