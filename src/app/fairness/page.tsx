  ...
  return (
    ...
    >
      ...
      <p className={`text-3xl font-mono font-semibold tracking-tight ${color ?? 'text-slate-900'}`}>
        {value}
        {unit && <span className="text-base font-sans text-slate-500 ml-1">{unit}</span>}
      </p>
              ...
              <div className="flex justify-between items-center py-2">
                ...
                <span
                  className={`flex items-center gap-1 font-mono font-medium ${
                    trend30d < 0 ? 'text-emerald-700' : trend30d > 0 ? 'text-red-600' : 'text-slate-500'
                  }`}
                >
